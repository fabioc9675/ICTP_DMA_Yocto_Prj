#################### PMOD 1 Upper ###################################
set_property PACKAGE_PIN H12 [get_ports {leds_0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[0]}]

set_property PACKAGE_PIN E10 [get_ports {leds_0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[1]}]

set_property PACKAGE_PIN D10 [get_ports {leds_0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[2]}]

set_property PACKAGE_PIN C11 [get_ports {leds_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[3]}]

#################### PMOD 1 Lower ###################################
set_property PACKAGE_PIN B10 [get_ports {leds_0[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[4]}]

set_property PACKAGE_PIN E12 [get_ports {leds_0[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[5]}]

set_property PACKAGE_PIN D11 [get_ports {leds_0[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[6]}]

set_property PACKAGE_PIN B11 [get_ports {leds_0[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[7]}]


###################### PMOD 2 Upper ###################################
#set_property PACKAGE_PIN J11 [get_ports {leds_0[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[0]}]

#set_property PACKAGE_PIN J10 [get_ports {leds_0[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[1]}]

#set_property PACKAGE_PIN K13 [get_ports {leds_0[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[2]}]

#set_property PACKAGE_PIN K12 [get_ports {leds_0[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[3]}]

###################### PMOD 2 Lower ###################################
#set_property PACKAGE_PIN H11 [get_ports {leds_0[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[4]}]

#set_property PACKAGE_PIN G10 [get_ports {leds_0[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[5]}]

#set_property PACKAGE_PIN F12 [get_ports {leds_0[6]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[6]}]

#set_property PACKAGE_PIN F11 [get_ports {leds_0[7]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {leds_0[7]}]
